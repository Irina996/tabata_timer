...
import com.example.ppo1.AppConstants
import com.example.ppo1.TimerActivity
import com.example.ppo1.R
import com.example.ppo1.TimerNotificationActionReceiver
...
class NotificationUtil {
    companion object{
        ...
        private const val CHANNEL_NAME_TIMER = "Tabata_Timer"
        ...
        fun showTimerExpired(context: Context) {
            ...
            val startPendingIntent = PendingIntent.getBroadcast(context,
                0, startIntent, PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        fun showTimerPaused(context: Context) {
            ...
            val resumePendingIntent = PendingIntent.getBroadcast(context, 0,
                resumeIntent, PendingIntent.FLAG_IMMUTABLE or PendingIntent.FLAG_UPDATE_CURRENT)
        ...
        private fun getBasicNotificationBuilder(context: Context,
                                                channelId: String, playSound: Boolean)
